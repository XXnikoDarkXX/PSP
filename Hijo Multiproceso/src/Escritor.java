...
public class Escritor {
	...
	public void escribir(String msg) throws IOException {
		FileWriter escritorIndividual=new FileWriter(individual,true);//lo pone true porque lo que hace 
		//llamar al escritor y para que le machaque lo que tenga
		FileWriter escritorComun=new FileWriter(comun,true);
		
		
		escritorIndividual.write(msg+"\n");//Escribe los mensajes en el fichero
