...
public class Escritor {
	 ...
	 * @param machacarIndividual Si está a true, machaca el contenido de los ficheros, dejándolos en blanco. Si no, concatenará.
	 * @param machacarComun Si está a true, machaca el contenido de los ficheros, dejándolos en blanco. Si no, concatenará.
