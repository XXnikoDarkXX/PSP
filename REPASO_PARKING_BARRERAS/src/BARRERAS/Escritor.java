...
/**
 * Clase que se encarga de escribir lo que se le mande por argumentos a su
 * funcion tanto en un fichero individual, como en un fichero colectivo y por
 * consola
 * 
...
public class Escritor {
	...
	private String comun;// Ruta donde se va a escribir el proceso actual de forma colectiva: Todos los
							// procesos ejecutados en paralelo se escriben en el mismo sitio

	/**
	 * Constructor de la clase, recibe dos rutas de ficheros en las que escribir
	 * 
	 * @param FicheroLogIndividual, ruta del fichero Log donde escribira el proceso
	 *                              actual
	 * @param FicheroLogComun,      ruta del fichero Log donde se escribiran los
	 *                              procesos en paralelo
	 * @param machacarIndividual    si esta a true, machaca el contenido de los
	 *                              ficheros, dejandolos en blanco. Si no,
	 *                              concatenara
	 * @param MachacarComun         si esta a true, machaca el contenido de los
	 *                              ficheros, dejandolos en blando. Si no,
	 *                              concatenara
	 * @throws IOException, la lanza si no puede escribir
	 */
	public Escritor(String FicheroLogIndividual, String FicheroLogComun, boolean machacarIndividual,
			boolean MachacarComun) throws IOException {
	...
	/**
	 * Función que escribe el mensaje tanto en el fichero individual, en el comun y
	 * por consola
	 * 
